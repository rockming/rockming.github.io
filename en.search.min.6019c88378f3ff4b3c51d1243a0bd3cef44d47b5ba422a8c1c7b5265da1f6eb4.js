...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4902d511a1dbdb3f301912209b623749268465245b5416f81cd33a1041386ed2.js',function(){input.required=false;search();});}
